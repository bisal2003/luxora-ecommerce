                    ...
                    checkout?(
                        <Stack rowGap={2} width={'100%'}>
                            ...
                            <Stack flexDirection={'row'} justifyContent={'space-between'}>
                                ...
                                <Typography>₹{TAXES.toLocaleString('en-IN')}</Typography> 
                            </Stack>
                            ...
                            <Stack flexDirection={'row'} justifyContent={'space-between'}>
                                ...
                                <Typography>₹{(subtotal+SHIPPING+TAXES).toLocaleString('en-IN')}</Typography>
                            </Stack>
                        ...
                        <>
                            ...
                            <Stack>
                                <Typography variant='h6' fontWeight={500}>₹{subtotal.toLocaleString('en-IN')}</Typography>
                            </Stack>
                        </>
                    )
                }
